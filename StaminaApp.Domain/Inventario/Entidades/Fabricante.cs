...
namespace StaminaApp.Domain.Inventario.Entidades
{
    ...
    {
        public Fabricante(string nome, Documento documento, Telefone telefone, Email email, Endereco endereco, string responsavel)
        {
            Nome = nome;
            Documento = documento;
            Telefone = telefone;
            ...
            AddNotifications(Documento, Endereco, Telefone, Email,Endereco,new Contract()
                .Requires()
                .HasMinLen(Nome,1,"Fabricante.Nome","Nome deve pelo menos 1 caracteres")
                .HasMaxLen(Nome,100,"Fabricante.Nome","Nome deve até 100 caracteres")
